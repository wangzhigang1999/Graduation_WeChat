...
Page({
    ...
    BtnToConfirm: function(){
      ...
      .then((filePath) => {
          ...
          wx.request({
            url: 'https://www.bupt.site/graduation/user/addBasicInfo',
            method: "GET",
            data: {
                  ...
                  wx.uploadFile({
                    ...
                    success(res){
                      ...
                      if(result.success==false){
                        ...
                        setTimeout(function(){
                          wx.navigateTo({
                            url: '/pages/uploadMyInfo/uploadFinishPage/uploadFinishPage?uuid='+ self.data.uuid + '&openId=' + self.data.openId + '&remark=' + self.data.remark + '&userFinalImg=' + filePath + "&userName=" + self.data.userName,
                          })
                        },200)
                      }
                    }
